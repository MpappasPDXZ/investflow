...
def create_properties_schema() -> pa.Schema:
    ...
    return pa.schema([
        ...
        pa.field("purchase_price", pa.int64(), nullable=False),  # int64 in dollars
        pa.field("down_payment", pa.int64(), nullable=True),  # int64 in dollars
        pa.field("cash_invested", pa.int64(), nullable=True),  # int64 in dollars
        pa.field("current_market_value", pa.int64(), nullable=True),  # int64 in dollars
        pa.field("property_status", pa.string(), nullable=True),
        pa.field("vacancy_rate", pa.float64(), nullable=True),  # float64
        pa.field("purchase_date", pa.date32(), nullable=True),  # date32 (not timestamp)
        ...
        pa.field("unit_count", pa.int64(), nullable=True),  # number of units
        pa.field("bedrooms", pa.int64(), nullable=True),
        pa.field("bathrooms", pa.float64(), nullable=True),  # float64 allows one decimal place (e.g., 1.5, 2.5)
        pa.field("square_feet", pa.int64(), nullable=True),
        pa.field("year_built", pa.int64(), nullable=True),
        pa.field("current_monthly_rent", pa.float64(), nullable=True),  # float64
...
def create_units_schema() -> pa.Schema:
    ...
    return pa.schema([
        ...
        pa.field("bedrooms", pa.int64(), nullable=True),  # int64
        pa.field("bathrooms", pa.float64(), nullable=True),  # float64 allows one decimal place
        pa.field("square_feet", pa.int64(), nullable=True),  # int64
        pa.field("current_monthly_rent", pa.float64(), nullable=True),  # float64
        pa.field("notes", pa.string(), nullable=True),
        pa.field("created_at", pa.timestamp("us"), nullable=True),
        pa.field("updated_at", pa.timestamp("us"), nullable=True),
...
def create_document_storage_schema() -> pa.Schema:
    ...
    return pa.schema([
        ...
        pa.field("file_size", pa.int32(), nullable=True),  # int32 is sufficient (max ~2GB file size)
