...
# ACTUAL TABLE ORDER (from inspect_table.py):
# id, property_id, expense_type, item_name, purchase_price, depreciation_rate,
# annual_cost, principal, interest_rate, notes, is_active, count, created_at, updated_at
...
# ACTUAL TABLE ORDER (from inspect_table.py):
# id, property_id, revenue_type, item_name, notes, is_active, annual_amount,
# appreciation_rate, property_value, value_added_amount, created_at, updated_at
