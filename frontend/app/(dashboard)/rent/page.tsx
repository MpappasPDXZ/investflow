          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">{rents.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8 text-red-500">Error loading rent payments</div>
          ) : rents.length === 0 ? (
            <div className="text-center py-12">
              <DollarSign className="h-12 w-12 text-gray-300 mx-auto mb-3" />
              <p className="text-gray-500 mb-4">No rent payments logged yet</p>
              <Button
                onClick={() => router.push('/rent/log')}
                variant="outline"
                className="text-sm"
